    ...
    with arg_scope(
      ...
      with arg_scope([layers.batch_norm], is_training=is_training):
        ...
        if include_root_block:
          ...
          net = layers_lib.max_pool2d(net, [3, 3], stride=1, scope='pool1')
...
resnet_v1.default_image_size = 32
...
def resnet_v1_26(inputs,
                 ...
                 reuse=None,
                 scope='resnet_v1_50'):
  """ResNet-26 model of [1]. See resnet_v1() for arg and return description."""
  blocks = [
